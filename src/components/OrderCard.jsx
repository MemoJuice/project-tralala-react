export default function OrderCard ({order}){
    return (
		<div className="grid grid-cols-[1.4fr_.6fr_.8fr_.8fr_.1fr] gap-3 items-center p-3 rounded-xl bg-white shadow-sm">
					...
					<div className="font-bold justify-self-center">฿{order.price}</div>
					<div className="font-bold col-span-2 justify-self-center md:col-span-1 md:pl-4">฿{order.price}</div>
