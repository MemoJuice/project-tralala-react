...
export default function UserCard (){
  ...
  <div className="ml-6 flex-1">
    ...
    <div className="mb-2">
      <span className="inline-block w-36 font-medium">วันเกิด:</span>
      <span>12 ธันวาคม 1954</span>
    </div>
    <div className="mb-2">
      <span className="inline-block w-36 font-medium">อายุ:</span>
      <span>71 ปี</span>
    </div>
    <div className="mb-2">
      <span className="inline-block w-36 font-medium">เพศ :</span>
      <span>หญิง</span>
    </div>
    <div className="mb-2">
      <span className="inline-block w-36 font-medium">ลักษณะอาการ :</span>
      <span></span>
    </div>
    <div className="mb-2">
      <span className="inline-block w-36 font-medium">เบอร์โทรศัพท์ :</span>
      <span></span>
    </div>
  </div>
</div>
