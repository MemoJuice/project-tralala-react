export default function AdminDashboard() {
    return (
        <>
        <div className="bg-yellow-200 w-auto pt-5 flex flex-col gap-20">
            ...
            <section className="flex flex-col justify-center text-center items-center sm:flex-row sm:pl-200 ">
                <div className="bg-gray-900 w-80 h-80 rounded-[5%] sm:w-400 sm:h-120 sm:mx-40 ">
                    <p className="text-white font-bold  ">Daily Sales
            ...
            <section className="flex justify-center items-center flex flex-col bg-yellow-200 w-auto ">
            ...
            <section className="flex justify-center bg-yellow-200 w-auto ">
                <div className="bg-gray-900 w-80 h-50 rounded-2xl flex justify-start sm:flex-row ">
            ...
            <section className="bg-yellow-200 w-auto  flex flex-col justify-center items-center ">
                <div className="bg-pink-300 w-80 h-60 rounded-2xl py-3">
                    <p className="font-bold pl-20">Realtime active users
                    </p>
                    <img className="w-100 px-10 py-7" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSB6gi2p1rZGCWrCECYZQ1dqMl562afSu-fzA&s"/>
                </div>
            </section>
        </div>
        </>
