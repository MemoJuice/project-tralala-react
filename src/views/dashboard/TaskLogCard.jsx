...
export default function TaskLogCard() {
  ...
  return (
    <div className="lg:col-span-1 rounded-3xl p-2 md:p-2 flex flex-col items-center justify-center shadow-lg bg-white">
      <div className="p-6 md:p-8 flex-1">
        {/* Header */}
        <div className="flex items-start gap-3 md:gap-2 mb-2 md:mb-2">
        ...
        {/* Info */}
        <div className="grid grid-cols-2 md:grid-cols-2 gap-4 md:gap-4 mb-4 md:mb-6">
          ...
          <div className="bg-linear-to-br from-blue-50 to-blue-100 rounded-2xl p-3 md:p-4">
            <div className="flex items-center gap-2 mb-1 md:mb-2">
              ...
              <span className="text-xs md:text-sm text-gray-600">วันที่</span>
            </div>
            <p className="text-base md:text-xl font-bold text-gray-900">
              {task.visitDate}
            </p>
